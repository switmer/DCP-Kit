#!/usr/bin/env node
/**
 * Apply site-bindings.json to registry.json for thefirestore experiment.
 * Same pattern as experiments/bungee-pro/import-bindings.mjs.
 */
...
// Also import GSS-declared extensions (non-canonical roles)
